...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   fn_validate_syntax.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: pecavalc <pecavalc@student.42berlin.de>    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/10 13:17:15 by pecavalc          #+#    #+#             */
/*   Updated: 2025/10/10 18:35:34 by pecavalc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int validade_vertical_bars(t_token *curr_token);

int	validate_syntax(t_token *token_lst)
{
	t_token	*curr_token;
